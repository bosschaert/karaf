...
// TODO this should be at least moved to a separate package, if not a separate module...
public class KarafMBeanServerBuilder extends MBeanServerBuilder {
    ...
    public MBeanServer newMBeanServer(String defaultDomain, MBeanServer outer, MBeanServerDelegate delegate) {
        /* */ System.out.println("~~~Creating Karaf wrapper MBean Server");

        InvocationHandler handler = new MBeanInvocationHandler(super.newMBeanServer(defaultDomain, outer, delegate));
        return (MBeanServer) Proxy.newProxyInstance(getClass().getClassLoader(),
    ...
    private static final class MBeanInvocationHandler implements InvocationHandler {
        ...
        private final List<String> guarded = Collections.unmodifiableList(Arrays.asList(
